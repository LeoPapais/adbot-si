...
%>    
    ...
    <meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
        <title>AdBot: Criar Media</title> <!-- Título da página -->
...
%>
            ...
            <!------ Título da página ------>
            <h3><center><font size="5" color="#FF5773">Criação de <i>Media</i></font></center></h3>
 <%    
     
       System.out.println("confirmou");
       System.out.println("request.getParameter(\"Confirmar\")");
       System.out.println(request.getParameter("Confirmar"));
     if ( request.getParameter("Confirmar") != null ) { 
       System.out.println("confirmou");
     String Nome = request.getParameter("Nome");
       String Tipo_produto = request.getParameter("Tipo_produto");
       String Endereco_REST_API_chatbot = request.getParameter("Endereco_REST_API_chatbot");
       String CPC_minimo = request.getParameter("CPC_minimo");
       MediaController tn = new MediaController();
       CriacaoUpdateMediaDTO media = new CriacaoUpdateMediaDTO();
       media.setNome(Nome);
       media.setTipo_produto(Tipo_produto);
       media.setEndereco_REST_API_chatbot(Endereco_REST_API_chatbot); 
       media.setCPC_minimo(Float.parseFloat(CPC_minimo)); 
       tn.criarMedia(Usuario_ID, media);
       pageContext.forward("Listagem_medias.jsp");
}
%>
            <br><hr><br>
            <form method="post" action=Criacao_de_media.jsp>
                Nome <input type="text" name="Nome" />
                Tipo_produto<input type="text" name="Tipo_produto" />
                Endereco_REST_API_chatbot<input type="text" name="Endereco_REST_API_chatbot" />
                CPC_minimo<input type="text" name="CPC_minimo" />
