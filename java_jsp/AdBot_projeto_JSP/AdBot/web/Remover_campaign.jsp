...
%>    
    ...
    <meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
        <title>AdBot: Remover Campaign</title> <!-- Título da página -->
    ...
    <body id="main_body" >
        ...
        <div id="form_container">
            ...
            <!------ Linha 2 ------>
            <a id="Botao_Perfi_publisher" href="Perfil_de_publisher.jsp" class="button_options2">Perfil de <i>Advertiser</i></a>
...
%>
            ...
            <a id="Botao_cancelar" href="Listagem_campaigns.jsp" class="button_options2">Cancelar</a>
