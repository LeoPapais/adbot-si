<%-- 
    ...
    Histórico de edição deste arquivo :
            ...
            [06/12/2916] Douglas - adaptaçao para Remover_usuario.jsp
--%>
...
<%         
    ...
    if ( request.getParameter("Confirmar") != null ) { 
       ...
       pageContext.forward("Listagem_publishers.jsp");
}
%>
    ...
    <body id="main_body" >
        ...
        <div id="form_container">
            ...
            <br>
            <h3><font size="5"><center>Deseja Remover o usuário?</center></font></h3>
            <br><br>
            ...
            <center>
                <table class="A">
                    <tr class ="C">
                        ...
                        <td>
                            <center>
                                <a id=<%= String.format("Botao_cancelar")%>, href="Listagem_publishers.jsp" class="button_blocked">&nbsp Cancelar &nbsp</a>
                            </center>
                        </td>
                    </tr>
                </table>
