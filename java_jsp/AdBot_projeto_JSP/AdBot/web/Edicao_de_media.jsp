...
%>    
    ...
    <meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
        <title>AdBot: Editar Media</title> <!-- Título da página -->
...
%>
            ...
            <!------ Título da página ------>
            <h3><center><font size="5" color="#FF5773">Edição de <i>Media</i></font></center></h3>
            <%    
                ...
                if ( request.getParameter("Confirmar") != null ) { 
                  ...
                  tn.editarMedia(Media_ID, media);
                  pageContext.forward("Listagem_medias.jsp");
           }
                
%>
            <br><hr><br>
            <form method="post" action=Edicao_de_media.jsp>
