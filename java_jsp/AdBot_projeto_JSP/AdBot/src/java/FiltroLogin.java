/*
 * FiltroLogin: Funções de filtro de Log in
 *
 * Classe fornecida aos alunos em "Aplicação Exemplo (com login) usando JSP - nova versão (04.10.2011)": http://monoceros.mcca.ep.usp.br/CGL/disciplinas/sistemas-de-informacao/itens
 *
 * Histórico de edição deste arquivo :
 *           Baixado de http://monoceros.mcca.ep.usp.br/CGL/disciplinas/sistemas-de-informacao/itens
 *           [02/11/2016] Diego - Inclusão no projeto
 *
 */
